...
class Room {
  ...
  addParticipant(socketId, ageVerified) {
    ...
    if (this.roomActive && this.startTime) {
      // Room already started, no new members
      return null;
    }
...
io.on('connection', (socket) => {
  ...
  socket.on('erase', (data) => {
    ...
    // Remove matching canvas elements
    room.canvasData = room.canvasData.filter(item => {
